...
(define (install-complex-package)
    ...
    ;(define (add z1 z2) (make-complex-from-real-imag (+ real-part z1) ((table-get 'real-part '(complex)) z2))
...
(define (apply-generic op . args)
    (apply (table-get op (list (car (get-tag (car args))) (car (get-tag (car args))))) (map get-contents args)))
